...
export const LOAD_USER_REVIEWS_SUCCESS = createActionType(
  'LOAD_USER_REVIEWS_SUCCESS'
);
export const LOAD_RECENT_REVIEWS = createActionType('LOAD_RECENT_REVIEWS');
export const LOAD_RECENT_REVIEWS_SUCCESS = createActionType(
...
export const UPDATE_SEMESTER_FILTER = createActionType(
  'UPDATE_SEMESTER_FILTER'
);
export const UPDATE_RATING_FILTER = createActionType('UPDATE_RATING_FILTER');
export const UPDATE_DIFFICULTY_FILTER = createActionType(
...
export const PROCESS_FILTERS_SUCCESS = createActionType(
